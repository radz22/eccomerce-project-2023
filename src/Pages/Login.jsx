   ...
   {loading ? (
    ...
    <div className=' w-full flex justify-center items-center flex-col'>
       ...
       <div className='bg-white w-5/12	px-4 py-4 	 flex justify-center items-center flex-col rounded	 max-lg:w-8/12	max-md:w-9/12	max-sm:w-10/12	'>
           <div className='mt-5'>
            <h2 className='text-2xl	 font-medium		text-[#777777]'>Login</h2>
           </div>
           ...
           <div>
            <button className=' text-white  bg-[#232f3e] py-3 px-5 text-lg	rounded-full  hover:bg-[#febd89] hover:text-black'>Login</button>
           </div>
